    ...
    extend: {
      ...
      keyframes: {
        ...
        "card-flip": {
          ...
          "30%": { transform: "translateY(-100px) rotateY(180deg) scale(1.1)" },
          "60%": { transform: "translateY(-50px) rotateY(360deg) scale(1.05)" },
      ...
      animation: {
        ...
        "card-flip": "card-flip 1s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
      },
